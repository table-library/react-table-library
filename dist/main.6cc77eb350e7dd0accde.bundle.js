  ...
  [
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      var slicedToArray = __webpack_require__(184),
        ...
        definePropertyfrom_dll_reference_storybook_docs_dll = __webpack_require__(
          185
        ),
        definePropertyfrom_dll_reference_storybook_docs_dll_default = __webpack_require__.n(
          definePropertyfrom_dll_reference_storybook_docs_dll
        ),
        ...
        Context = delegated_reactfrom_dll_reference_storybook_docs_dll.createContext(
          null
        ),
        taggedTemplateLiteral = __webpack_require__(34),
        taggedTemplateLiteral_default = __webpack_require__.n(
          taggedTemplateLiteral
        ),
        styled_components_browser_esm = __webpack_require__(35);
      ...
      var Table_Content = styled_components_browser_esm.a.div(
        _templateObject()
      );
      ...
      var BodyContainer = styled_components_browser_esm.a.div(
          Body_templateObject()
        ),
        Body_Body = function Body(_ref) {
          var children = _ref.children;
          return delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
            BodyContainer,
            null,
            children
          );
      ...
      'undefined' != typeof STORYBOOK_REACT_CLASSES &&
        (STORYBOOK_REACT_CLASSES[
          'src/components/Table/Table/Body/index.js'
        ] = {
          name: 'Body',
          docgenInfo: Body_Body.__docgenInfo,
          path: 'src/components/Table/Table/Body/index.js'
        });
      var Table_Header = styled_components_browser_esm.a.div(
          Header_templateObject()
        ),
        classnames =
          (__webpack_require__(12), __webpack_require__(88)),
        classnames_default = __webpack_require__.n(classnames);
      function Row_templateObject() {
        var data = taggedTemplateLiteral_default()([
          '\n  display: flex;\n  align-items: center;\n\n  padding-left: 52px;\n  padding-right: 16px;\n'
        ]);
        return (
          (Row_templateObject = function _templateObject() {
            return data;
          }),
          data
        );
      }
      var RowContainer = styled_components_browser_esm.a.div(
          Row_templateObject()
        ),
        Row_Row = function Row(_ref) {
          var disabled = _ref.disabled,
            children = _ref.children;
          return delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
            RowContainer,
            {
              className: classnames_default()('tr', {
                disabled: disabled
              })
            },
            delegated_reactfrom_dll_reference_storybook_docs_dll.Children.map(
              children,
              function(child, index) {
                return delegated_reactfrom_dll_reference_storybook_docs_dll.cloneElement(
                  child,
                  {
                    noIndent: 0 === index,
                    noBorder:
                      index ===
                      delegated_reactfrom_dll_reference_storybook_docs_dll.Children.count(
                        children
                      ) -
                        1
                  }
      ...
      var HeaderRow = Row_Row;
      (Row_Row.__docgenInfo = {
        description: '',
        methods: [],
        displayName: 'Row',
        props: {
        ...
        'undefined' != typeof STORYBOOK_REACT_CLASSES &&
          (STORYBOOK_REACT_CLASSES[
            'src/components/Table/Table/Row/index.js'
          ] = {
            name: 'Row',
            docgenInfo: Row_Row.__docgenInfo,
            path: 'src/components/Table/Table/Row/index.js'
          });
      var IconChevronSingleDown_IconChevronSingleDown = function IconChevronSingleDown(
        _ref
      ) {
        ...
        return delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
          ...
          delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
            'polygon',
            { points: '0 15 0 12 18 21 36 12 36 15 18 24 0 15' }
          )
        );
      };
      (IconChevronSingleDown_IconChevronSingleDown.propTypes = {
        height: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.oneOfType(
          [
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
              .a.string,
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
        ...
        strokeWidth: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.oneOfType(
          [
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
              .a.string,
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
        ...
        style: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.objectOf(
          delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
            .a.string
        ),
        viewBox:
          delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
            .a.string,
        width: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.oneOfType(
          [
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
              .a.string,
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
        ...
        (IconChevronSingleDown_IconChevronSingleDown.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'IconChevronSingleDown',
          props: {
            height: {
              type: {
                name: 'union',
      ...
      var Icons_IconChevronSingleDown = IconChevronSingleDown_IconChevronSingleDown;
      'undefined' != typeof STORYBOOK_REACT_CLASSES &&
        (STORYBOOK_REACT_CLASSES[
          'src/components/Icons/IconChevronSingleDown.js'
        ] = {
          name: 'IconChevronSingleDown',
          docgenInfo:
            IconChevronSingleDown_IconChevronSingleDown.__docgenInfo,
          path: 'src/components/Icons/IconChevronSingleDown.js'
        });
      var IconChevronSingleUp_IconChevronSingleUp = function IconChevronSingleUp(
        _ref
      ) {
        var width = _ref.width,
          height = _ref.height,
        ...
        return delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
          ...
          delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
            'polygon',
            { points: '36 21 36 24 18 15 0 24 0 21 18 12 36 21' }
          )
        );
      };
      (IconChevronSingleUp_IconChevronSingleUp.propTypes = {
        height: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.oneOfType(
          [
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
              .a.string,
        ...
        (IconChevronSingleUp_IconChevronSingleUp.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'IconChevronSingleUp',
          props: {
            height: {
              type: {
                name: 'union',
      ...
      var Icons_IconChevronSingleUp = IconChevronSingleUp_IconChevronSingleUp;
      'undefined' != typeof STORYBOOK_REACT_CLASSES &&
        (STORYBOOK_REACT_CLASSES[
          'src/components/Icons/IconChevronSingleUp.js'
        ] = {
          name: 'IconChevronSingleUp',
          docgenInfo:
            IconChevronSingleUp_IconChevronSingleUp.__docgenInfo,
          path: 'src/components/Icons/IconChevronSingleUp.js'
        });
      var IconChevronSingleUpDown_IconChevronSingleUpDown = function IconChevronSingleUpDown(
        _ref
      ) {
        var width = _ref.width,
          height = _ref.height,
        ...
        return delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
          ...
          delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
            'polygon',
            { points: '36 12 36 15 18 6 0 15 0 12 18 3 36 12' }
          ),
          delegated_reactfrom_dll_reference_storybook_docs_dll_default.a.createElement(
            'polygon',
            { points: '0 24 0 21 18 30 36 21 36 24 18 33 0 24' }
          )
        );
      };
      (IconChevronSingleUpDown_IconChevronSingleUpDown.propTypes = {
        height: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.oneOfType(
          [
            delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
              .a.string,
        ...
        (IconChevronSingleUpDown_IconChevronSingleUpDown.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'IconChevronSingleUpDown',
          props: {
            height: {
              type: {
                name: 'union',
      ...
      var Icons_IconChevronSingleUpDown = IconChevronSingleUpDown_IconChevronSingleUpDown;
      ...
      function Cell_templateObject() {
        ...
        return (
          (Cell_templateObject = function _templateObject() {
            return data;
          }),
          data
        );
      ...
      'undefined' != typeof STORYBOOK_REACT_CLASSES &&
        (STORYBOOK_REACT_CLASSES[
          'src/components/Icons/IconChevronSingleUpDown.js'
        ] = {
          name: 'IconChevronSingleUpDown',
          docgenInfo:
            IconChevronSingleUpDown_IconChevronSingleUpDown.__docgenInfo,
          path: 'src/components/Icons/IconChevronSingleUpDown.js'
        });
      var CellContainer = styled_components_browser_esm.a.div(
          Cell_templateObject(),
          function(props) {
            return props.width;
          },
          ...
          8,
          function(props) {
            return props.noIndent ? 0 : 22;
          },
          function(props) {
            return props.noBorder ? 'transparent' : '#b6cada';
          }
        ),
        HeaderCellContainer = Object(styled_components_browser_esm.a)(
          CellContainer
        )(_templateObject2()),
        HeaderCellContainerWithSort = Object(
          styled_components_browser_esm.a
        )(HeaderCellContainer)(_templateObject3()),
        BodyCellContainer = Object(styled_components_browser_esm.a)(
          CellContainer
        )(_templateObject4()),
        SortButton = styled_components_browser_esm.a.button(
          _templateObject5(),
          4
        ),
        Cell_HeaderCell = function HeaderCell(_ref) {
          var width = _ref.width,
            noIndent = _ref.noIndent,
          ...
          return delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
            ...
            delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
              'div',
              null,
              children
            )
      ...
      var Cell_HeaderSortCell = function HeaderSortCell(_ref2) {
        var sortKey = _ref2.sortKey,
          sortFn = _ref2.sortFn,
          width = _ref2.width,
          noIndent = _ref2.noIndent,
          ...
          function(value) {
            return delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
              HeaderCellContainerWithSort,
              {
                ...
                noIndent: noIndent,
                noBorder: noBorder,
                className: classnames_default()('th', 'has-sort', {
              ...
              delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
                ...
                delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
                  ...
                  (function getChevron(sort) {
                    return sort.key === sortKey && sort.reverse
                      ? delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
                          Icons_IconChevronSingleDown,
                          size
                        )
                      : sort.key !== sortKey || sort.reverse
                      ? delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
                          Icons_IconChevronSingleUpDown,
                          size
                        )
                      : delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
                          Icons_IconChevronSingleUp,
                          size
                        );
                  })(value.sort),
                  delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
      ...
      var Cell_Cell = function Cell(_ref3) {
        var width = _ref3.width,
          noIndent = _ref3.noIndent,
        ...
        for (var i = 1; i < arguments.length; i++) {
          ...
          i % 2
            ? ownKeys(Object(source), !0).forEach(function(key) {
                definePropertyfrom_dll_reference_storybook_docs_dll_default()(
                  target,
                  key,
                  source[key]
                );
      ...
      (Cell_Cell.propTypes = {
        ...
        (Cell_HeaderSortCell.__docgenInfo = {
          description: '',
          methods: [],
          displayName: 'HeaderSortCell',
          props: {
            sortKey: {
              type: { name: 'string' },
              required: !0,
        ...
        'undefined' != typeof STORYBOOK_REACT_CLASSES &&
          (STORYBOOK_REACT_CLASSES[
            'src/components/Table/Table/Cell/index.js'
          ] = {
            name: 'HeaderCell',
            docgenInfo: Cell_HeaderCell.__docgenInfo,
            path: 'src/components/Table/Table/Cell/index.js'
          }),
        'undefined' != typeof STORYBOOK_REACT_CLASSES &&
          (STORYBOOK_REACT_CLASSES[
            'src/components/Table/Table/Cell/index.js'
            ...
            name: 'HeaderSortCell',
            docgenInfo: Cell_HeaderSortCell.__docgenInfo,
            path: 'src/components/Table/Table/Cell/index.js'
          }),
        'undefined' != typeof STORYBOOK_REACT_CLASSES &&
          (STORYBOOK_REACT_CLASSES[
            ...
            name: 'Cell',
            docgenInfo: Cell_Cell.__docgenInfo,
            path: 'src/components/Table/Table/Cell/index.js'
          });
      var sortReducer = function sortReducer(state, action) {
          switch (action.type) {
            case 'SET_SORT':
              var needsReverse =
                action.payload.sort.key === state.key &&
                !state.reverse;
              return _objectSpread(
                _objectSpread({}, action.payload.sort),
                {},
                needsReverse
                  ? {
                      reverse: !0,
                      fn: function fn(array) {
        ...
        Table_Table = function Table(_ref) {
          var list = _ref.list,
            children = _ref.children,
            _React$useReducer = delegated_reactfrom_dll_reference_storybook_docs_dll.useReducer(
              sortReducer,
              {
                key: null,
                reverse: !1,
            ...
            _React$useReducer2 = slicedToArray_default()(
              _React$useReducer,
              2
            ),
            sort = _React$useReducer2[0],
            sortDispatcher = _React$useReducer2[1];
          return delegated_reactfrom_dll_reference_storybook_docs_dll.createElement(
            Context.Provider,
            {
              value: {
      ...
      (Table_Table.propTypes = {
        list: delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default.a.arrayOf(
          delegated_prop_typesfrom_dll_reference_storybook_docs_dll_default
            .a.any
        ).isRequired,
        children:
        ...
        (Table_Table.Content = Table_Content),
        (Table_Table.Header = Table_Header),
        (Table_Table.HeaderCell = Cell_HeaderCell),
        (Table_Table.HeaderSortCell = Cell_HeaderSortCell),
        (Table_Table.Body = Table_Body),
        (Table_Table.HeaderRow = HeaderRow),
        (Table_Table.Row = Row_Row),
        (Table_Table.Cell = Cell_Cell),
        ...
        'undefined' != typeof STORYBOOK_REACT_CLASSES &&
          (STORYBOOK_REACT_CLASSES[
            ...
            path: 'src/components/Table/Table/index.js'
          });
    },
    function(module, exports, __webpack_require__) {
    ...
    ,
    function(module, exports, __webpack_require__) {
      module.exports = __webpack_require__(1)('KEM+');
    },
    ,
    function(module, exports, __webpack_require__) {
    ...
    function(module, exports, __webpack_require__) {
      ...
      __webpack_require__(2),
        ...
        __webpack_require__(7),
        __webpack_require__(28);
      var _clientApi = __webpack_require__(46),
        _clientLogger = __webpack_require__(31),
        _configFilename = __webpack_require__(421);
      function ownKeys(object, enumerableOnly) {
        var keys = Object.keys(object);
        if (Object.getOwnPropertySymbols) {
          var symbols = Object.getOwnPropertySymbols(object);
      ...
      (_configFilename.args || _configFilename.argTypes) &&
        ...
        _configFilename.argTypesEnhancers &&
          _configFilename.argTypesEnhancers.forEach(function(
            enhancer
          ) {
    ...
    function(module, exports, __webpack_require__) {
      'use strict';
      (function(module) {
        (0, __webpack_require__(59).configure)(
    ...
    function(module, exports, __webpack_require__) {
      var map = {
        './components/Sort/stories.js': 441,
        './components/Table/stories.js': 442
      };
    ...
    function(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.r(__webpack_exports__),
        function(module) {
          ...
          )('02. Table with Sort', module)
            .addParameters({
              storySource: {
                source:
                  "import React from 'react';\nimport { storiesOf } from '@storybook/react';\n\nstoriesOf('02. Table with Sort', module)\n  // .addParameters({ component: Table })\n  .add('01. with ascending/descending', () => {\n    return <div>WIP</div>;\n  });\n",
                locationsMap: {
                  '01-with-ascending-descending': {
                    startLoc: { col: 7, line: 6 },
                    endLoc: { col: 3, line: 8 },
                    startBody: { col: 40, line: 6 },
                    endBody: { col: 3, line: 8 }
                  }
                }
              }
            })
            .add('01. with ascending/descending', function() {
              return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                'div',
                null,
                'WIP'
      ...
      __webpack_require__.r(__webpack_exports__),
        function(module) {
          ...
          var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
            ...
            ___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36),
            list = [
              {
                id: '1',
                name: 'Hello',
          ...
          Object(
              ...
              storySource: {
                ...
                locationsMap: {
                  '01-default': {
                    ...
                    startBody: { col: 22, line: 26 },
                    endBody: { col: 3, line: 70 }
                  }
                }
              }
            })
            ...
            .add('01. default', function() {
              return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                ___WEBPACK_IMPORTED_MODULE_4__.a,
                { list: list },
                function(tableList) {
                  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                    ___WEBPACK_IMPORTED_MODULE_4__.a.Content,
                    null,
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                      ___WEBPACK_IMPORTED_MODULE_4__.a.Header,
                      null,
                      react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                        ___WEBPACK_IMPORTED_MODULE_4__.a.HeaderRow,
                        null,
                        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                          ___WEBPACK_IMPORTED_MODULE_4__.a.HeaderCell,
                          { width: '25%' },
                          'Name'
                        ),
                        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                          ___WEBPACK_IMPORTED_MODULE_4__.a.HeaderCell,
                          { width: '25%', isGroupEnd: !0 },
                          'Stars'
                        ),
                        react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                          ___WEBPACK_IMPORTED_MODULE_4__.a.HeaderCell,
                    ...
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                      ...
                      tableList.map(function(item) {
                        return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                          ___WEBPACK_IMPORTED_MODULE_4__.a.Row,
                          { key: item.id },
                          react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
                            ___WEBPACK_IMPORTED_MODULE_4__.a.Cell,
                            { width: '25%' },
                            item.name
                          ),
                          react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(
    ...
    function(module, exports, __webpack_require__) {
      module.exports = __webpack_require__(1)('xt6W');
    }
  ],
  [[189, 1, 2]]
]);
//# sourceMappingURL=main.6cc77eb350e7dd0accde.bundle.js.map
